<?php
	...
	// fetcging data from database using id for update
	$id = $_GET['id'];
	if(isset($id)){
	...
	if(isset($_REQUEST['submit'])){
		...
		$query = "UPDATE routes SET direction = '$route_name' WHERE id = $id";
      ...
      <div class="container">
	  	<div class="row">
				<div class="col-md-10 content-heading">
					<h3 class="text-center">Edit Route</h3>		
				</div>
				<div class="col-md-6 col-md-offset-2">
					<form method="post" action="">
		 				<div class="form-group">
								<label for="route_name" >Route Name</label>
								<input value="<?= $result[0]['direction'] ?>" type="text" class="form-control route_name" id="route_name" name="route_name" >
							</div>
							<div class="form-group">
								<input type="submit" value="EDIT" name="submit" class="btn btn-primary btn-block">
							</div> 
		 			</form>	
				</div>
